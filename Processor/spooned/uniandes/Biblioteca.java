...
public class Biblioteca extends uniandes.cupi2.biblioteca.mundo.AbstractBiblioteca {
     ...
     */
    private uniandes.cupi2.collections.arbol.avl.ArbolAVL<uniandes.NodoIndice>  indiceNombre;
    
    /** 
     * �rbol AVL de libros ordenado por palabras en el autor.
     */
    private uniandes.cupi2.collections.arbol.avl.ArbolAVL<uniandes.NodoIndice>  indiceAutor;
    
    /** 
     * �rbol AVL de libros ordenado por por palabras clave.
     */
    private uniandes.cupi2.collections.arbol.avl.ArbolAVL<uniandes.NodoIndice>  indicePalabraClave;
    
    /** 
     * Tabla de hashing con los usuarios que hay en la Biblioteca ordenados por el login.
     */
    private uniandes.cupi2.collections.tablaHashing.ITablaHashing<java.lang.String, uniandes.Usuario>  tablaUsuario;
    ...
    public Biblioteca(java.lang.String rutaArchivoLibros ,java.lang.String rutaArchivosUsuarios) {
        ...
        indiceAutor = new uniandes.cupi2.collections.arbol.avl.ArbolAVL<uniandes.NodoIndice> ();
        indiceNombre = new uniandes.cupi2.collections.arbol.avl.ArbolAVL<uniandes.NodoIndice> ();
        indicePalabraClave = new uniandes.cupi2.collections.arbol.avl.ArbolAVL<uniandes.NodoIndice> ();
        tablaUsuario = new uniandes.cupi2.collections.tablaHashing.tablaHashingEstatica.TablaHashingEstatica<java.lang.String, uniandes.Usuario> ();
        numeroTotalCopias = 0;
    ...
    public boolean autenticar(java.lang.String login, java.lang.String clave) {
        uniandes.Usuario usuario = tablaUsuario.dar(login);
    ...
    public void insertarUsuario(java.lang.String login, java.lang.String clave, java.lang.String nombre) throws uniandes.cupi2.biblioteca.mundo.excepciones.UsuarioPreexistenteException {
        uniandes.Usuario usuario = new uniandes.Usuario(login , clave , nombre);
    ...
    public void insertarLibro(java.lang.String titulo, java.lang.String[] autores, java.lang.String[] descriptores, int ejemplares, java.lang.String ref) throws uniandes.cupi2.biblioteca.mundo.excepciones.LibroYaExisteException {
        uniandes.Libro libro = new uniandes.Libro(titulo , autores , descriptores , ejemplares , ref);
        insertarLibro(libro);
    }
    ...
    public uniandes.cupi2.collections.iterador.Iterador<uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorTitulo(java.lang.String[] datos) {
        ...
        for (int i = 0 ; i < (datos.length) ; i++) {
            uniandes.NodoIndice nodo = indiceNombre.buscar(new uniandes.NodoIndice(datos[i]));
            if (nodo != null) {
    ...
    public uniandes.cupi2.collections.iterador.Iterador<uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorAutores(java.lang.String[] datos) {
        uniandes.cupi2.collections.conjunto.Conjunto<uniandes.cupi2.biblioteca.mundo.ILibro>  resultados = new uniandes.cupi2.collections.conjunto.Conjunto<uniandes.cupi2.biblioteca.mundo.ILibro> ();
        for (int i = 0 ; i < (datos.length) ; i++) {
            uniandes.NodoIndice nodo = indiceAutor.buscar(new uniandes.NodoIndice(datos[i]));
            if (nodo != null) {
                uniandes.cupi2.collections.iterador.Iterador<uniandes.cupi2.biblioteca.mundo.ILibro>  iterador = nodo.darLibros();
                while (iterador.haySiguiente())
                    resultados.insertar(iterador.darSiguiente());
    ...
    public uniandes.cupi2.collections.iterador.Iterador<uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorDescriptoresExacto(java.lang.String[] datos) {
        uniandes.cupi2.collections.conjunto.Conjunto<uniandes.cupi2.biblioteca.mundo.ILibro>  resultados = new uniandes.cupi2.collections.conjunto.Conjunto<uniandes.cupi2.biblioteca.mundo.ILibro> ();
        if ((datos.length) > 0) {
            uniandes.cupi2.collections.iterador.Iterador<uniandes.cupi2.biblioteca.mundo.ILibro>  iterador = indicePalabraClave.buscar(new uniandes.NodoIndice(datos[0])).darLibros();
            while (iterador.haySiguiente()) {
    ...
    public uniandes.cupi2.collections.iterador.Iterador<uniandes.cupi2.biblioteca.mundo.ILibro>  buscarPorDescriptores(java.lang.String[] datos) {
        uniandes.cupi2.collections.conjunto.Conjunto<uniandes.cupi2.biblioteca.mundo.ILibro>  resultados = new uniandes.cupi2.collections.conjunto.Conjunto<uniandes.cupi2.biblioteca.mundo.ILibro> ();
        for (int i = 0 ; i < (datos.length) ; i++) {
            uniandes.NodoIndice nodoResultante = indicePalabraClave.buscar(new uniandes.NodoIndice(datos[i]));
    ...
    public void devolverLibro(java.lang.String elUsuario, java.lang.String referencia) {
        uniandes.Usuario usuario = tablaUsuario.dar(elUsuario);
        uniandes.cupi2.biblioteca.mundo.ILibro libro = tablaLibroReferencia.dar(referencia);
    ...
    public void cargar() throws uniandes.cupi2.biblioteca.mundo.excepciones.CargarBibliotecaException {
        try {
            ...
            throw new uniandes.cupi2.biblioteca.mundo.excepciones.CargarBibliotecaException("Problemas en la versi�n del archivo binario de libros.");
        ...
        try {
            ...
            throw new uniandes.cupi2.biblioteca.mundo.excepciones.CargarBibliotecaException("Problemas en la versi�n del archivo binario de usuarios.");
     ...
     */
    private void insertarUsuario(uniandes.Usuario usuario) throws uniandes.cupi2.biblioteca.mundo.excepciones.UsuarioPreexistenteException {
     ...
     */
    private void insertarEnIndice(uniandes.cupi2.biblioteca.mundo.ILibro libro, uniandes.cupi2.collections.arbol.avl.ArbolAVL<uniandes.NodoIndice>  indice, java.lang.String[] llaves) {
        try {
            for (int i = 0 ; i < (llaves.length) ; i++) {
                uniandes.NodoIndice nodoTemp = new uniandes.NodoIndice(llaves[i]);
                uniandes.NodoIndice nodo = indice.buscar(new uniandes.NodoIndice(llaves[i]));
                if (nodo == null) {
